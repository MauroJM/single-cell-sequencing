...
# rename part of the plates if you have different experiments in one plate
# do this only for one of the .coutt files at the time by choosing the location in the .coutt list
# and manually specify which cells are renamed to what
